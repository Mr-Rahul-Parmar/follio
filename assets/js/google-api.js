...
*/
    var Ba = [], Ca = function (a) {
        ...
        if (b = I(J(), "safevalues").D) {
            var c = "A URL with content '" + a + "' was sanitized away.", d = ua;
            if (a = b) if (a = b && d) {
                a = d.value;
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var K = window, L = document, Da = K.location, Ea = function () {
    }, Fa = /\[native code\]/, M = function (a, b, c) {
        return a[b] = a[b] || c
    }, Ga = function (a) {
        a = a.sort();
        ...
        var a;
        if ((a = Object.create) && Fa.test(a)) a = a(null); else {
            a = {};
    ...
    var T = M(R, "perf", N()), Ka = M(T, "g", N()), La = M(T, "i", N());
    M(T, "r", []);
    N();
    N();
    ...
    var Pa = /^(\/[a-zA-Z0-9_\-]+)+$/, Qa = [/\/amp\//, /\/amp$/, /^\/amp$/], Ra = /^[a-zA-Z0-9\-_\.,!]+$/,
        Sa = /^gapi\.loaded_[0-9]+$/, Ta = /^[a-zA-Z0-9,._-]+$/, Xa = function (a, b, c, d, e) {
            var f = a.split(";"), k = f.shift(), m = Oa[k], l = null;
        ...
        Wa = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, Va = /\/cb=/g, Ua = /\/\//g;
    ...
    var Y = decodeURI("%73cript"), ab = /^[-+_0-9\/A-Za-z]+={0,2}$/, bb = function (a, b) {
        ...
        l = M(S(c), "r", []).sort();
        var ca = M(S(c), "L", []).sort(), nb = R.le || [], O = [].concat(l), Ha = function (x, E) {
            if (ba) return 0;
            K.clearTimeout(A);
            ca.push.apply(ca, r);
    ...
    window.gapi.load("", {
        callback: window["gapi_onload"], _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.S9zOXUg9rrA.O/d=1/rs=AHpOoo-AXjUK4hNAaKzui0P9Fr9nG2_yZQ/m=__features__",
